...
module.exports = (slapp) => {
  slapp.command('/assignment', 'create(.*)', (msg, text, assignmentName) => {
    ...
    db.User.findOne({ where: {slackId: userSlackId} }).then( (user) => {
      ...
      if (assignmentName === '') {
        ...
        msg.respond('Creating Assignment' + assignmentName)
...
slapp.route('handleSubmission', (msg, assignment) => {
  ...
  console.log('submitting assignment' + msg.body.event.text)
